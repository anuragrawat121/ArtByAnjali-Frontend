    ...
    return (
        <>
            <motion.nav 
                ...
                className="fixed top-0 left-0 w-full z-50 px-6 py-2 md:px-12 md:py-4"
            >
            ...
            {/* MOBILE MENU OVERLAY - Outside of hideable nav */}
            <AnimatePresence>
                {isOpen && (
                    <motion.div 
                        ...
                        className="fixed inset-0 bg-[#1A1512] z-[1000] flex flex-col items-center justify-center gap-12"
                    >
                        {/* MOBILE BACK ACTION */}
                        <motion.button 
